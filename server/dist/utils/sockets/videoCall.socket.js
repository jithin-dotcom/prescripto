...
exports.videoCallSocketHandler = void 0;
const callLog_service_1 = require("../../services/implementation/callLog.service");
const callLog_repository_1 = require("../../repositories/implementation/callLog.repository");
...
const callLogRepository = new callLog_repository_1.CallLogRepository();
...
const callLogService = new callLog_service_1.CallLogService(callLogRepository, appointmentRepository, walletRepository, walletHistoryRepository);
const activeCalls = new Map();
const connectedUsers = new Map();
const videoCallSocketHandler = (io, socket) => {
    ...
    socket.on("register-user", (userId) => {
        ...
        if (connectedUsers.has(userId)) {
            ...
            (_a = connectedUsers.get(userId)) === null || _a === void 0 ? void 0 : _a.disconnect();
        }
    ...
    socket.on("end-call", (_a) => __awaiter(void 0, [_a], void 0, function* ({ to, from, appointmentId }) {
        ...
        if (session) {
            ...
            try {
                yield callLogService.logCall({
                    doctorId: new mongoose_1.default.Types.ObjectId(session.doctorId),
                    patientId: new mongoose_1.default.Types.ObjectId(session.patientId),
                    appointmentId: session.appointmentId
                        ? new mongoose_1.default.Types.ObjectId(session.appointmentId)
                        : undefined,
                ...
                const wallet = yield callLogService.paymentDoctor({
                    userId: new mongoose_1.default.Types.ObjectId(session.doctorId),
                    role: "doctor",
                });
                yield callLogService.doctorPaymentHistory({
                    appointmentId: new mongoose_1.default.Types.ObjectId(session.appointmentId),
                    walletId: wallet._id,
                });
            }
            catch (err) {
    ...
    socket.on("disconnect", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (userId) {
            ...
            if (session === null || session === void 0 ? void 0 : session.appointmentId) {
...
exports.videoCallSocketHandler = videoCallSocketHandler;
