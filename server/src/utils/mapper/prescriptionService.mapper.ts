...
import { IPrescriptionDocPopulated, IPrescriptionClean, IPatientHistoryPopulated, IPatientHistoryClean } from "../../models/prescription/IPrescription";
...
export function mapPatientHistoryDTO(
  prescription: IPatientHistoryPopulated 
): IPatientHistoryClean {
  return {
    _id: prescription._id.toString(),
    appointmentId: {
      _id: prescription.appointmentId._id.toString(),
