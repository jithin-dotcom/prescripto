...
//           className="mb-6 max-w-md relative"
//         >
//           <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
//           <input
//             type="text"
...
//                   className="pl-5 pr-5 py-3 border border-[#C9D8FF] rounded-lg cursor-pointer transition duration-300 hover:bg-[#5F6FFF] hover:text-white bg-white shadow-sm text-center sm:text-left"
//                   onClick={() => {
...
//                       onClick={() => navigate(`/appointment/${doctor._id}`)}
//                       className="flex flex-col border border-[#C9D8FF] rounded-xl bg-white shadow-sm overflow-hidden transition group cursor-pointer"
//                     >
//                       <div className="w-full aspect-[4/3] bg-[#EAEFFF] hover:bg-[#5F6FFF] transition duration-300">
//                         <img
//                           src={doctor.photo || "https://via.placeholder.com/300x200?text=Doctor"}
