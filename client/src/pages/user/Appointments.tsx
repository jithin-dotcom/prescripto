...
//       name: "Prescripto Hospital",
//       description: "Appointment Fee",
//       order_id: order.id,
//       handler: async (response: any) => {
//         // 3. On payment success, create appointment
...
//   try {
//     // 1. Create appointment first (temp, unpaid)
//     const res = await axiosInstance.post(APIUserRoutes.CREATE_APPOINTMENTS, {
//       doctorId,
//       date: selectedSlot.date,
//       time: activeTime,
...
//     const userId = res.data.userId; // you should pass this from backend or frontend
//     const amount = res.data.doctorFee; // or hardcode if fixed
...
// const handleBooking = async () => {
//   if (!doctorId || !slots[activeSlotIndex] || !activeTime || !doctor) return;
...
//   const now = new Date();
//   const diffInMinutes = (appointmentDateTime.getTime() - now.getTime()) / 60000;
//   if (diffInMinutes < 60) {
//     toast.error("Please book at least 1 hour in advance.");
//     return;
//   }
...
//     const orderRes = await axiosInstance.post(`/payments/create-order`, {
//       //  appointmentId: , // generate or pass this
//   userId: userId,             // get from auth context or state
//   doctorId: doctorId,                    // already available
//   amount: doctor.fee,
//     });
...
//       order_id: orderRes.data.id,
//       handler: async (response: any) => {
//         // On successful payment, book appointment
//         try {
//           const appointmentRes = await axiosInstance.post(APIUserRoutes.CREATE_APPOINTMENTS, {
//             doctorId,
//             date: selectedSlot.date,
//             time: activeTime,
...
//     if (!window.Razorpay || !orderRes.data.id || !orderRes.data.amount) {
//   toast.error("Payment initialization failed. Missing Razorpay fields.");
//   return;
// }
