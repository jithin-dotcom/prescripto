...
const UserConcernsPage: React.FC = () => {
  ...
  useEffect(() => {
    if (role !== 'user') {
      setError('Unauthorized access. Please log in as a user.');
      setLoading(false);
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex flex-col">
      <NavbarUser />
      <main className="flex-1 p-4 sm:p-6 lg:p-8 overflow-y-auto bg-gradient-to-br from-blue-100 to-indigo-100">
        <ConcernsList
          concerns={concerns}
