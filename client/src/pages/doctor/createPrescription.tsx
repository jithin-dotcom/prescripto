...
//       navigate("/doctor-appointments"); // redirect or anywhere else
//     } catch (error) {
...
//         <p className="text-red-600 text-lg">No appointment data available.</p>
//       </div>
//     );
//   }
...
//       <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-6 sm:p-10 space-y-6">
//         <div className="flex items-center justify-between">
//           <h2 className="text-2xl font-bold text-blue-800">Write Prescription</h2>
//           <button
//             onClick={() => navigate(-1)}
...
//           <div>
//             <label className="block font-semibold mb-2">Follow-up Date</label>
//             <input
//               type="datetime-local"
//               value={followUpDate}
...
//               <div key={index} className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mb-4">
