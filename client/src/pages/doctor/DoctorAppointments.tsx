...
//               <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-xl shadow-2xl border border-blue-100 hover:scale-103 transition duration-300">
//                 <div className="text-2xl font-bold text-blue-900">{stats.total}</div>
//                 <div className="text-sm text-blue-700 flex items-center gap-1">
//                   <CalendarIcon className="w-4 h-4" /> Total
//                 </div>
//               </div>
//               <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 p-4 rounded-xl shadow-2xl border border-yellow-100 hover:scale-103 transition duration-300">
//                 <div className="text-2xl font-bold text-yellow-900">{stats.pending}</div>
//                 <div className="text-sm text-yellow-700 flex items-center gap-1">
//                   <Clock className="w-4 h-4" /> Pending
//                 </div>
//               </div>
//               <div className="bg-gradient-to-br from-green-50 to-green-100 p-4 rounded-xl shadow-2xl border border-green-100  hover:scale-103 transition duration-300">
//                 <div className="text-2xl font-bold text-green-900">{stats.confirmed}</div>
//                 <div className="text-sm text-green-700 flex items-center gap-1">
//                   <Check className="w-4 h-4" /> Confirmed
//                 </div>
//               </div>
//               <div className="bg-gradient-to-br from-red-50 to-red-100 p-4 rounded-xl shadow-2xl border border-red-100 hover:scale-103 transition duration-300">
...
//                 </div>
//               </div>
//               <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-4 rounded-xl shadow-2xl border border-gray-100 hover:scale-103 transition duration-300">
