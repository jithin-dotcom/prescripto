          ...
          <form onSubmit={handleSubmit} className="max-w-4xl mx-auto bg-white p-6 shadow-2xl rounded hover:scale-101 transition duration-300">
            ...
            <div className="flex items-center gap-4 mb-4">
              <label htmlFor="signature">
                <img
                  src={typeof signature === "string" ? signature : signature ? URL.createObjectURL(signature) : assets.upload_area}
                  className="w-32 h-16 object-contain bg-gray-100 cursor-pointer border rounded"
                  alt="Signature"
                />
              </label>
              <input type="file" id="signature" accept="image/*" hidden onChange={e => setSignature(e.target.files?.[0] || null)} />
