...
//         console.log("res.data.message : ",res.data.messages)
...
//     setInput((prev) => prev + emojiObject.emoji); // Append selected emoji to input
...
const ChatDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col font-sans mt-12">
      <Layout />
      <main className="flex-1 flex flex-col md:flex-row gap-4 p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto w-full">
        <motion.div
          initial={{ opacity: 0, x: -20 }}
