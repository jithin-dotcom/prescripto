...
//           <h1 className="text-2xl font-semibold text-gray-700">Appointment Details</h1>
//           <button
...
//               {/* Doctor Info */}
//               <motion.div className="bg-white rounded-xl shadow p-6" whileHover={{ scale: 1.02 }}>
//                 <h2 className="text-lg font-semibold mb-4 border-b pb-2">Doctor Information</h2>
//                 <div className="flex items-center gap-4 mb-4">
//                   <img src={doctor.photo} alt="Doctor" className="w-20 h-20 rounded-full border object-cover" />
//                   <div>
//                     <p className="font-medium">{doctor.name}</p>
//                     <p className="text-sm text-gray-500">{doctor.email}</p>
//                     <p className="text-sm text-gray-500">{doctor.specialization}</p>
