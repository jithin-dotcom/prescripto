...
const ChangePassword = () => {
  ...
  //         <NavbarAdmin />
  //         <main className="flex-1 flex items-center justify-center bg-gradient-to-tr from-blue-50 to-white px-4 py-6">
  //           {FormContent}
  //         </main>
  //       </div>
  //     </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-tr from-blue-50 to-white flex flex-col">
      ...
      {/* Sidebar and Content below the navbar */}
