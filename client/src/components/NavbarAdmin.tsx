...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {user?.role === "doctor" && !user?.isVerified && (
        <div
          className="bg-orange-500 border-b border-red-300 overflow-hidden h-8 cursor-pointer mt-16 sm:mt-0"
          onClick={() => navigate("/doctor-profile")}
        >
          <div className="marquee text-sm text-white font-medium whitespace-nowrap py-2">
            <span>
              Your account is not verified. Please upload your certificates to get verified and start receiving appointments.
            </span>
            <span className="mx-4">
